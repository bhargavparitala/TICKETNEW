...
<head>
	...
	<style type="text/css">
		...
		#new{
			height: 550px;
			width: 100%;
			background-image: url('TicketNow...png');
			opacity: 0.8;
			position: relative;
			top: 125px;
		}
...
<body style="background-color: lightgray;">
		...
		<div style= "width:23%; height: 49.5px; position: absolute; padding-left: 10%;box-sizing: border-box;top:45px;">
			<img src = "TicketNow...png" width = "150" height="80"style="position:fixed;">
			<a href = "index1.html" style = "position: absolute; font-family: 'Oswald', sans-serif;color: White; font-weight: bold;font-size: 20px;text-decoration: none; left: 95%;">TICKET NEW</a>
		</div>
		<div id="login">
