...
<body style="background-color: darkgray;">
		...
		<div style= "width:23%; height: 49.5px; position: absolute; padding-left: 10%;box-sizing: border-box;top:45px;">
			...
			<a href = "index1.html" style = "position: absolute; font-family: 'Oswald', sans-serif;color: White; font-weight: bold;font-size: 20px;text-decoration: none; left: 65%;">TICKET NEW</a>
		</div>
		<div id="login">
		...
		<div id="new">
			...
			<div id="form1">
				...
				<h1 style="color: white; opacity: 0.65;">Please Book your ticket</h1>
				<textarea rows="28" cols="75" name="textbox" style="background-color:white;" placeholder="Only Text Blogs..."></textarea>

				<button type="submit" name="submit_blog" style="position: relative; bottom: 0px;">BOOK TICKET</button>
				</form>
